...
def test_0_client_capture_jpeg(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_1_client_capture_jpeg(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_2_client_capture_png(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_3_client_capture_capture(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_4_client_capture_bmp(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_5_client_deploy_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_8_client_deploy_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_9_client_deploy_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_11_client_deploy_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_12_client_deploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_13_client_deploy_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_14_client_deploy_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_15_client_deploy_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_16_client_deploy_list_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy_list",
...
def test_17_client_deploy_list_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy_list",
...
def test_18_client_file_copy_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_copy",
           "--from_path",
           "/file_client/upload/dog.jpg",
           "--to_path",
           "/file_client/upload/dog2.jpg",
           "--scope",
           "client",
           "--client_data",
           "C:/Users/hama/.iinfer",
...
def test_19_client_file_copy_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_copy",
           "--from_path",
           "/file_server/upload/dog.jpg",
           "--to_path",
           "/file_server/upload/dog2.jpg",
           "--orverwrite",
           "--scope",
           "server",
           "--debug"]
...
def test_20_client_file_copy_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_copy",
           "--from_path",
           "/file_current/upload/dog.jpg",
           "--to_path",
           "/file_current/upload/dog2.jpg",
           "--scope",
           "current",
           "--debug"]
...
def test_21_client_file_download_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_download",
...
def test_22_client_file_download_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_download",
...
def test_23_client_file_download_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_download",
...
def test_24_client_file_list_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_list",
...
def test_25_client_file_list_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_list",
...
def test_26_client_file_list_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_list",
...
def test_27_client_file_mkdir_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_mkdir",
...
def test_28_client_file_mkdir_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_mkdir",
...
def test_29_client_file_mkdir_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_mkdir",
...
def test_30_client_file_move_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_move",
...
def test_31_client_file_move_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_move",
...
def test_32_client_file_move_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_move",
...
def test_33_client_file_remove_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_remove",
...
def test_34_client_file_remove_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_remove",
...
def test_35_client_file_remove_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_remove",
...
def test_36_client_file_rmdir_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_rmdir",
...
def test_37_client_file_rmdir_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_rmdir",
...
def test_38_client_file_rmdir_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_rmdir",
...
def test_39_client_file_upload_client(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_upload",
...
def test_40_client_file_upload_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_upload",
...
def test_41_client_file_upload_current(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_upload",
...
def test_42_client_predict_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_43_client_predict_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_44_client_predict_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_45_client_predict_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_46_client_predict_upernet(capfd, monkeypatch):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_47_client_predict_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_48_client_predict_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_49_client_predict_custom(capfd, monkeypatch):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_50_client_predict_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_51_client_read_dir_jpeg(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_52_client_read_dir_png(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_53_client_read_dir_capture(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_54_client_read_dir_bmp(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_55_client_read_dir_filelist(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_56_client_start_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_57_client_start_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_58_client_start_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_59_client_start_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_60_client_start_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_61_client_start_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_62_client_start_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_63_client_start_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_64_client_start_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_65_client_stop_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_66_client_stop_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_67_client_stop_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_68_client_stop_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_69_client_stop_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_70_client_stop_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_71_client_stop_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_72_client_stop_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_73_client_stop_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_74_client_train_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "train",
...
def test_75_client_undeploy_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_76_client_undeploy_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_77_client_undeploy_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_78_client_undeploy_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_79_client_undeploy_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_80_client_undeploy_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_81_client_undeploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_82_client_undeploy_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_83_client_undeploy_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
