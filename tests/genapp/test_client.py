...
def test_0_client_read_dir_png(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_1_client_read_dir_jpeg(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_4_client_read_dir_filelist(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_5_client_capture_png(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_9_client_capture_capture(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "capture",
...
def test_10_client_deploy_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_11_client_deploy_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_12_client_deploy_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_16_client_deploy_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_17_client_deploy_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_19_client_deploy_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_20_client_deploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_23_client_start_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_25_client_start_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_26_client_start_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_27_client_start_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_28_client_start_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_30_client_start_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_31_client_start_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_32_client_predict_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_34_client_predict_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_35_client_predict_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_36_client_predict_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_37_client_predict_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_39_client_predict_custom(capfd, monkeypatch):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_40_client_predict_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_41_client_stop_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_43_client_stop_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_44_client_stop_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_45_client_stop_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_46_client_stop_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_48_client_stop_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_49_client_stop_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_50_client_undeploy_swin(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_52_client_undeploy_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_53_client_undeploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_54_client_undeploy_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_55_client_undeploy_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_57_client_undeploy_custom(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_58_client_undeploy_san(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_59_client_file_list_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_list",
...
def test_60_client_file_list_local(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_list",
...
def test_61_client_file_mkdir_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_mkdir",
...
def test_62_client_file_mkdir_local(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_mkdir",
...
def test_63_client_file_rmdir_server(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_rmdir",
...
def test_64_client_file_rmdir_local(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "file_rmdir",
