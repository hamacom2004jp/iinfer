...
def test_3_client_read_dir_filelist(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "read_dir",
...
def test_10_client_deploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_12_client_deploy_effnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_16_client_deploy_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_18_client_deploy_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_19_client_deploy_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "deploy",
...
def test_23_client_start_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_27_client_start_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_28_client_start_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_30_client_start_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_31_client_start_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "start",
...
def test_32_client_predict_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_36_client_predict_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_37_client_predict_upernet(capfd, monkeypatch):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_39_client_predict_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_40_client_predict_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "predict",
...
def test_41_client_stop_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_45_client_stop_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_46_client_stop_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_48_client_stop_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_49_client_stop_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "stop",
...
def test_50_client_undeploy_yolo3(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_54_client_undeploy_pspnet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_55_client_undeploy_upernet(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_57_client_undeploy_yolox(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
...
def test_58_client_undeploy_lnsightface(capfd):
    cmd = ["-m",
           "client",
           "-c",
           "undeploy",
