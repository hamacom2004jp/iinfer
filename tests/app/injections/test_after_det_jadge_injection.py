...
def test_after_det_jadge_injection_action():
    ...
    """
    # AfterDetJadgeInjection インスタンスを作成します
    injection = AfterDetJadgeInjection(dict(ok_score_th=0.8, ok_classes=[1, 3]), Mock())
    ...
    outputs = {
        "success": {
            ...
            "output_boxes": [[0, 0, 50, 50], [0, 0, 10, 10], [0, 0, 40, 40], [0, 40, 0, 40]],
            "output_labels": ["label1", "label2", "label3", "label4"],
            "output_tracks": [1, 2, 3, 4]
        }
    }
