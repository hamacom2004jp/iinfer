                    ...
                    choise=[
                        ...
                        dict(opt="model_file", type="file", default="", required=True, multi=False, hide=False, choise=None, fileio="in",
                            ...
                            test_true={"yolox":"https://download.openmmlab.com/mmdetection/v2.0/yolox/yolox_s_8x8_300e_coco/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth",
                                       ...
                                       "lnsightface":"https://drive.google.com/file/d/1pKIusApEfoHKDjeBTXYB3yOQ0EtTonNE/view?usp=sharing",
                                       "yolo3":"https://github.com/onnx/models/blob/main/validated/vision/object_detection_segmentation/yolov3/model/yolov3-10.onnx",
                                       "effnet":"https://github.com/onnx/models/blob/main/validated/vision/classification/efficientnet-lite4/model/efficientnet-lite4-11-qdq.onnx",
                        ...
                        dict(opt="model_conf_file", type="file", default="", required=False, multi=True, hide=False, choise=None, fileio="in",
                            ...
                            test_true={"yolox":["iinfer/extensions/configs/mmdet/yolox_s_8xb8-300e_coco.py","iinfer/extensions/configs/mmdet/yolox_tta.py"],
                                       ...
                                       "san":["iinfer/extensions/configs/mmseg/san/san-vit-b16_coco-stuff164k-640x640.py"],
                        ...
                        dict(opt="predict_type", type="str", default="", required=False, multi=False, hide=False,
                            ...
                            test_true={"yolox":"mmdet_det_YoloX",
                                       ...
                                       "custom":"Custom"},
                            test_false={"yolox":"mmdet_det_YoloY"}),
                        dict(opt="custom_predict_py", type="file", default="", required=False, multi=False, hide=True, choise=None, fileio="in",
                            ...
                            test_true={"yolox":None,
                                       "custom":"iinfer/tools/datas/libs/mmdet_det_YoloX2.py"}),
                        ...
                        dict(opt="before_injection_conf", type="file", default="", required=False, multi=False, hide=True, choise=None, fileio="in",
                            ...
                            test_true={"yolox":"iinfer/extensions/injection/before_gray_injection.json"},
                            test_false={"yolox":"iinfer/extensions/injection/before_gray_injection.XXX"}),
                        dict(opt="before_injection_py", type="file", default="", required=False, multi=True, hide=True, choise=None, fileio="in",
                            ...
                            test_true={"custom":"iinfer/extensions/injection/before_grayimg_injection2.py"},
                            test_false={"custom":"iinfer/extensions/injection/before_grayimg_injection2.XXX"}),
                        ...
                        dict(opt="after_injection_conf", type="file", default="", required=False, multi=False, hide=True, choise=None, fileio="in",
                            ...
                            test_true={"yolox":"iinfer/tools/datas/after_injection.json"},
                            test_false={"yolox":"iinfer/tools/datas/after_injection.XXX"}),
                        dict(opt="after_injection_py", type="file", default="", required=False, multi=True, hide=True, choise=None, fileio="in",
                            ...
                            test_true={"custom":"iinfer/tools/datas/after_det_filter_injection2.py"},
                            test_false={"custom":"iinfer/tools/datas/after_det_filter_injection2.XXX"}),
                ...
                train=dict(
                    ...
                    choise=[
                        ...
                        dict(short="n", opt="name", type="str", default="", required=True, multi=False, hide=False, choise=None,
                            discription_ja="AIモデルの登録名を指定します。",
                            discription_en="Specify the registration name of the AI model."),
                        dict(opt="dataset", type="dir", default="", required=True, multi=False, hide=False, choise=None, fileio="in",
                            discription_ja="データセットディレクトリを指定します。",
                            discription_en="Specifies the data set directory."),
                        dict(opt="dataset_upload", type="bool", default=True, required=False, multi=False, hide=False, choise=[True, False],
                            discription_ja="データセットをサーバーにアップロードします。",
                            discription_en="Upload the data set to the server."),
                        dict(opt="model_conf_file", type="file", default="", required=True, multi=True, hide=False, choise=None, fileio="in",
                            discription_ja="モデル設定ファイルを指定します。複数指定可能ですが、最初に指定したファイルが `train` 時に使用されます。",
                            discription_en="Specify the model configuration file. Multiple specifications are possible, but the file specified first is used at `train` time."),
                        dict(opt="train_type", type="str", default="", required=True, multi=False, hide=False,
                ...
                read_dir=dict(
                    ...
                    choise=[
                        ...
                        dict(opt="polling_count", type="int", default=10, required=False, multi=False, hide=True, choise=None,
                             discription_ja="ディレクトリ内の読込みの繰り返し回数を指定します。",
                             discription_en="Specifies the number of repeated readings in the directory."),
