...
class ClientStop(feature.OneshotNotifyEdgeFeature):
    ...
    def get_option(self):
        ...
        return dict(
            ...
            description_ja="AIモデルを指定して推論サーバーを停止します。",
            description_en="Stop the inference server by specifying the AI model.",
            choice=[
