    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="score_th", type="float", default="0.0", required=False, multi=False, hide=False, choice=None,
                        discription_ja="bboxのクラススコアがこの値以下のものは除去します。",
                        discription_en="Remove bboxes with class scores less"),
                dict(opt="width_th", type="int", default="0", required=False, multi=False, hide=False, choice=None,
                        discription_ja="bboxの横幅がこの長さ以下のものは除去します。",
                        discription_en="Remove bboxes with a width less than this length."),
                dict(opt="height_th", type="int", default="0", required=False, multi=False, hide=False, choice=None,
                        discription_ja="bboxの縦幅がこの長さ以下のものは除去します。",
                        discription_en="Remove bboxes with a height less than this length."),
                dict(opt="classes", type="str", default="", required=False, multi=True, hide=False, choice=None,
