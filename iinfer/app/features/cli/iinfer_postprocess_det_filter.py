    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="score_th", type=Options.T_FLOAT, default="0.0", required=False, multi=False, hide=False, choice=None,
                     description_ja="bboxのクラススコアがこの値以下のものは除去します。",
                     description_en="Remove bboxes with class scores less"),
                dict(opt="width_th", type=Options.T_INT, default="0", required=False, multi=False, hide=False, choice=None,
                     description_ja="bboxの横幅がこの長さ以下のものは除去します。",
                     description_en="Remove bboxes with a width less than this length."),
                dict(opt="height_th", type=Options.T_INT, default="0", required=False, multi=False, hide=False, choice=None,
                     description_ja="bboxの縦幅がこの長さ以下のものは除去します。",
                     description_en="Remove bboxes with a height less than this length."),
                dict(opt="classes", type=Options.T_STR, default=None, required=False, multi=True, hide=False, choice=None,
                     description_ja="このクラス以外のbboxは除去します。複数指定できます。",
                     description_en="Remove bboxes other than this class. Multiple specifications are possible."),
                dict(opt="labels", type=Options.T_STR, default=None, required=False, multi=True, hide=False, choice=None,
                     description_ja="このラベル以外のbboxは除去します。複数指定できます。",
                     description_en="Remove bboxes other than this label. Multiple specifications are possible."),
