    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="del_segments", type="bool", default=True, required=False, multi=False, hide=False, choice=[True, False],
                ...
                dict(opt="logits_th", type="float", default="-100.0", required=False, multi=False, hide=False, choice=None,
                     discription_ja="ピクセルごとのクラススコアがこの値以下のものは除去されます。",
                     discription_en="Pixels with class scores less than this value are removed."),
                dict(opt="classes", type="int", default="", required=False, multi=True, hide=True, choice=None,
                ...
                dict(opt="labels", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="del_logits", type="bool", default=True, required=False, multi=False, hide=False, choice=[True, False],
