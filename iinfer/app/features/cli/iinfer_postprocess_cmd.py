    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="cmdline", type="str", default='cwd', required=True, multi=False, hide=False, choice=None,
                ...
                dict(opt="output_image_ext", type="str", default="jpeg", required=True, multi=False, hide=True, choice=['bmp', 'png', 'jpeg'],
                ...
                dict(opt="output_maxsize", type="int", default=1024*1024*5, required=True, multi=False, hide=True, choice=None,
