    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="ok_score_th", type="float", default=None, required=False, multi=False, hide=False, choice=None,
                        discription_ja="クラススコアがこの値以上のものはok判定されます。",
                        discription_en="Class scores greater than this value are judged as ok."),
                dict(opt="ok_classes", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="ok_labels", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="ng_score_th", type="float", default=None, required=False, multi=False, hide=False, choice=None,
                        discription_ja="クラススコアがこの値以上のものはng判定されます。",
                        discription_en="Class scores greater than this value are judged as ng."),
                dict(opt="ng_classes", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="ng_labels", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="ext_score_th", type="float", default=None, required=False, multi=False, hide=False, choice=None,
                        discription_ja="クラススコアがこの値以上のものはgray判定されます。",
                        discription_en="Class scores greater than this value are judged as gray."),
                dict(opt="ext_classes", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="ext_labels", type="str", default="", required=False, multi=True, hide=False, choice=None,
                ...
                dict(opt="nodraw", type="bool", default=False, required=False, multi=False, hide=False, choice=[True, False],
                        discription_ja="推論結果画像にbbox等の描き込みを行いません。",
                        discription_en="Do not draw bboxes, etc. on the inference result image."),
                dict(short="P", opt="output_preview", type="bool", default=False, required=False, multi=False, hide=False, choice=[True, False],
                        discription_ja="判定結果画像を`cv2.imshow`で表示します。",
                        discription_en="Display the judgment result image with `cv2.imshow`."),
                dict(opt="output_image", type="file", default="", required=False, multi=False, hide=False, choice=None, fileio="out",
