    ...
    if args.boot_mode == 'client':
        ...
        if args.cmd_type == 'deploy':
            ...
            if args.predict_type == 'Custom' and args.custom_predict_py is None:
                ...
                exit(1)
            app.main(None, args.boot_mode, args.host, args.port, args.password,
            ...
            app.main(None, args.boot_mode, args.host, args.port, args.password, cmd_type=args.cmd_type, cmd_name=args.name, timeout=args.timeout, model_provider=args.model_provider)
        elif args.cmd_type == 'predict':
            image_file = Path(args.image_file) if args.image_file is not None else None
            app.main(None, args.boot_mode, args.host, args.port, args.password, cmd_type=args.cmd_type, cmd_name=args.name, timeout=args.timeout,
        ...
        if args.data is None:
            ...
            exit(1)
        app.main(Path(args.data), args.boot_mode, args.host, args.port, args.password)
    else:
        parser.print_help()
